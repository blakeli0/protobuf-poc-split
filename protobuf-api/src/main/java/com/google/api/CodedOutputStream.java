...
import com.google.api.Utf8.UnpairedSurrogateException;
...
public abstract class CodedOutputStream extends ByteOutput {
  ...
  @Deprecated public static final int LITTLE_ENDIAN_32_SIZE = WireFormat.FIXED32_SIZE;
  ...
  public static int computeInt32SizeNoTag(final int value) {
    if (value >= 0) {
      ...
      // Must sign-extend.
      return WireFormat.MAX_VARINT_SIZE;
    }
  }
  ...
  public static int computeFixed32SizeNoTag(@SuppressWarnings("unused") final int unused) {
    return WireFormat.FIXED32_SIZE;
  }
  ...
  public static int computeFixed64SizeNoTag(@SuppressWarnings("unused") final long unused) {
    return WireFormat.FIXED64_SIZE;
  }
  ...
  private static class ArrayEncoder extends CodedOutputStream {
    ...
    public final void writeUInt64NoTag(long value) throws IOException {
      if (HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= WireFormat.MAX_VARINT_SIZE) {
        while (true) {
          if ((value & ~0x7FL) == 0) {
  ...
  private static final class UnsafeDirectNioEncoder extends CodedOutputStream {
    ...
    UnsafeDirectNioEncoder(ByteBuffer buffer) {
      ...
      oneVarintLimit = limit - WireFormat.MAX_VARINT_SIZE;
    ...
    public void writeFixed32NoTag(int value) throws IOException {
      ...
      position += WireFormat.FIXED32_SIZE;
    }
    ...
    public void writeFixed64NoTag(long value) throws IOException {
      ...
      position += WireFormat.FIXED64_SIZE;
    }
  ...
  private abstract static class AbstractBufferedEncoder extends CodedOutputStream {
    ...
    AbstractBufferedEncoder(int bufferSize) {
      ...
      this.buffer = new byte[Math.max(bufferSize, WireFormat.MAX_VARINT_SIZE * 2)];
    ...
    final void bufferFixed32NoTag(int value) {
      ...
      buffer[position++] = (byte) ((value >> 16) & 0xFF);
      buffer[position++] = (byte) ((value >> 24) & 0xFF);
      totalBytesWritten += WireFormat.FIXED32_SIZE;
    }
    ...
    final void bufferFixed64NoTag(long value) {
      ...
      buffer[position++] = (byte) ((int) (value >> 48) & 0xFF);
      buffer[position++] = (byte) ((int) (value >> 56) & 0xFF);
      totalBytesWritten += WireFormat.FIXED64_SIZE;
    }
  }
  ...
  private static final class ByteOutputEncoder extends AbstractBufferedEncoder {
    ...
    @Override
    public void writeInt32(final int fieldNumber, final int value) throws IOException {
      flushIfNotAvailable(WireFormat.MAX_VARINT_SIZE * 2);
    ...
    @Override
    public void writeFixed32(final int fieldNumber, final int value) throws IOException {
      flushIfNotAvailable(WireFormat.MAX_VARINT_SIZE + WireFormat.FIXED32_SIZE);
    ...
    @Override
    public void writeFixed64(final int fieldNumber, final long value) throws IOException {
      flushIfNotAvailable(WireFormat.MAX_VARINT_SIZE + WireFormat.FIXED64_SIZE);
    ...
    @Override
    public void writeBool(final int fieldNumber, final boolean value) throws IOException {
      flushIfNotAvailable(WireFormat.MAX_VARINT_SIZE + 1);
      bufferTag(fieldNumber, WireFormat.WIRETYPE_VARINT);
    ...
    @Override
    public void writeUInt32NoTag(int value) throws IOException {
      flushIfNotAvailable(WireFormat.MAX_VARINT32_SIZE);
      bufferUInt32NoTag(value);
    }

    @Override
    public void writeFixed32NoTag(final int value) throws IOException {
      flushIfNotAvailable(WireFormat.FIXED32_SIZE);
      bufferFixed32NoTag(value);
    }

    @Override
    public void writeUInt64NoTag(long value) throws IOException {
      flushIfNotAvailable(WireFormat.MAX_VARINT_SIZE);
      bufferUInt64NoTag(value);
    }

    @Override
    public void writeFixed64NoTag(final long value) throws IOException {
      flushIfNotAvailable(WireFormat.FIXED64_SIZE);
      bufferFixed64NoTag(value);
    }
