...
private static final long serialVersionUID = 0L;
  ...
  public void writeTo(CodedOutputStream output)
    ...
    if (!GeneratedMessageV3.isStringEmpty(root_)) {
      GeneratedMessageV3.writeString(output, 2, root_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!GeneratedMessageV3.isStringEmpty(root_)) {
      size += GeneratedMessageV3.computeStringSize(2, root_);
    }
  ...
  private static final Parser<Mixin>
