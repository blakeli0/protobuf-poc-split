...
private static final long serialVersionUID = 0L;
  ...
  public enum KindCase
      implements Internal.EnumLite,
          AbstractMessage.InternalOneOfEnum {
    NULL_VALUE(1),
    NUMBER_VALUE(2),
    STRING_VALUE(3),
    BOOL_VALUE(4),
  ...
  public void writeTo(CodedOutputStream output)
    ...
    if (kindCase_ == 3) {
      GeneratedMessageV3.writeString(output, 3, kind_);
    }
    if (kindCase_ == 4) {
      output.writeBool(
  ...
  public int getSerializedSize() {
    ...
    if (kindCase_ == 3) {
      size += GeneratedMessageV3.computeStringSize(3, kind_);
    }
    if (kindCase_ == 4) {
      size += CodedOutputStream
        .computeBoolSize(
  ...
  public static final class Builder extends
    ...
    private SingleFieldBuilderV3<
      ...
      if (structValueBuilder_ == null) {
        ...
        structValueBuilder_ = new SingleFieldBuilderV3<
                    Struct, Struct.Builder, StructOrBuilder>(
    ...
    private SingleFieldBuilderV3<
      ...
      if (listValueBuilder_ == null) {
        ...
        listValueBuilder_ = new SingleFieldBuilderV3<
                    ListValue, ListValue.Builder, ListValueOrBuilder>(
