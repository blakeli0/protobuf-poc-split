...
private static final long serialVersionUID = 0L;
  ...
  public void writeTo(CodedOutputStream output)
    ...
    for (int i = 0; i < oneofs_.size(); i++) {
      GeneratedMessageV3.writeString(output, 3, oneofs_.getRaw(i));
    }
    ...
    if (!GeneratedMessageV3.isStringEmpty(edition_)) {
      GeneratedMessageV3.writeString(output, 7, edition_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!GeneratedMessageV3.isStringEmpty(edition_)) {
      size += GeneratedMessageV3.computeStringSize(7, edition_);
    }
  ...
  public static final class Builder extends
    ...
    private RepeatedFieldBuilderV3<
        ...
        getFieldsFieldBuilder() {
      if (fieldsBuilder_ == null) {
        fieldsBuilder_ = new RepeatedFieldBuilderV3<
                    Field, Field.Builder, FieldOrBuilder>(
                fields_,
    ...
    private void ensureOneofsIsMutable() {
      if (!oneofs_.isModifiable()) {
        oneofs_ = new LazyStringArrayList(oneofs_);
      }
      bitField0_ |= 0x00000004;
    }
    /**
  ...
  private static final Parser<Type>
