...
private static final long serialVersionUID = 0L;
  ...
  @SuppressWarnings("serial")
  private java.util.List<Method> methods_;
  /**
   * <pre>
  ...
  @SuppressWarnings("serial")
  private java.util.List<Mixin> mixins_;
  /**
   * <pre>
  ...
  public void writeTo(CodedOutputStream output)
    ...
    if (!GeneratedMessageV3.isStringEmpty(version_)) {
      GeneratedMessageV3.writeString(output, 4, version_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!GeneratedMessageV3.isStringEmpty(version_)) {
      size += GeneratedMessageV3.computeStringSize(4, version_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      size += CodedOutputStream
  ...
  public static final class Builder extends
    ...
    private RepeatedFieldBuilderV3<
        ...
        getMethodsFieldBuilder() {
      if (methodsBuilder_ == null) {
        methodsBuilder_ = new RepeatedFieldBuilderV3<
                    Method, Method.Builder, MethodOrBuilder>(
                methods_,
    ...
    private SingleFieldBuilderV3<
        ...
        getSourceContextFieldBuilder() {
      if (sourceContextBuilder_ == null) {
        sourceContextBuilder_ = new SingleFieldBuilderV3<
                    SourceContext, SourceContext.Builder, SourceContextOrBuilder>(
                getSourceContext(),
                getParentForChildren(),
                isClean());
    ...
    private RepeatedFieldBuilderV3<
        ...
        getMixinsFieldBuilder() {
      if (mixinsBuilder_ == null) {
        mixinsBuilder_ = new RepeatedFieldBuilderV3<
                    Mixin, Mixin.Builder, MixinOrBuilder>(
                mixins_,
  ...
  private static final Parser<Api>
