...
private static final long serialVersionUID = 0L;
  ...
  private MapField<String, Value>
  internalGetFields() {
    if (fields_ == null) {
      return MapField.emptyMapField(
...
com.google.protobuf.Value defaultValue) {
  ...
  public static final class Builder extends
    ...
    @SuppressWarnings({"rawtypes"})
    protected MapFieldReflectionAccessor internalGetMutableMapFieldReflection(
        int number) {
      switch (number) {
        case 1:
...
com.google.protobuf.Value defaultValue) {
  ...
  private static final Parser<Struct>
