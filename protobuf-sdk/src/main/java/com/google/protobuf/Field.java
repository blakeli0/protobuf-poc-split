...
private static final long serialVersionUID = 0L;
  ...
  public void writeTo(CodedOutputStream output)
    ...
    if (!GeneratedMessageV3.isStringEmpty(name_)) {
      GeneratedMessageV3.writeString(output, 4, name_);
    }
    if (!GeneratedMessageV3.isStringEmpty(typeUrl_)) {
      GeneratedMessageV3.writeString(output, 6, typeUrl_);
    }
    if (oneofIndex_ != 0) {
    ...
    if (!GeneratedMessageV3.isStringEmpty(jsonName_)) {
      GeneratedMessageV3.writeString(output, 10, jsonName_);
    }
    if (!GeneratedMessageV3.isStringEmpty(defaultValue_)) {
      GeneratedMessageV3.writeString(output, 11, defaultValue_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!GeneratedMessageV3.isStringEmpty(name_)) {
      size += GeneratedMessageV3.computeStringSize(4, name_);
    }
    if (!GeneratedMessageV3.isStringEmpty(typeUrl_)) {
      size += GeneratedMessageV3.computeStringSize(6, typeUrl_);
    }
    if (oneofIndex_ != 0) {
      size += CodedOutputStream
    ...
    if (!GeneratedMessageV3.isStringEmpty(jsonName_)) {
      size += GeneratedMessageV3.computeStringSize(10, jsonName_);
    }
    if (!GeneratedMessageV3.isStringEmpty(defaultValue_)) {
      size += GeneratedMessageV3.computeStringSize(11, defaultValue_);
    }
  ...
  public static final class Builder extends
    ...
    private RepeatedFieldBuilderV3<
      ...
      if (optionsBuilder_ == null) {
        optionsBuilder_ = new RepeatedFieldBuilderV3<
                    Option, Option.Builder, OptionOrBuilder>(
                options_,
  ...
  private static final Parser<Field>
