...
private static final long serialVersionUID = 0L;
  ...
  public void writeTo(CodedOutputStream output)
    ...
    if (!GeneratedMessageV3.isStringEmpty(requestTypeUrl_)) {
      GeneratedMessageV3.writeString(output, 2, requestTypeUrl_);
    }
    if (requestStreaming_ != false) {
      output.writeBool(3, requestStreaming_);
    }
    if (!GeneratedMessageV3.isStringEmpty(responseTypeUrl_)) {
      GeneratedMessageV3.writeString(output, 4, responseTypeUrl_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!GeneratedMessageV3.isStringEmpty(requestTypeUrl_)) {
      size += GeneratedMessageV3.computeStringSize(2, requestTypeUrl_);
    }
    if (requestStreaming_ != false) {
    ...
    if (!GeneratedMessageV3.isStringEmpty(responseTypeUrl_)) {
      size += GeneratedMessageV3.computeStringSize(4, responseTypeUrl_);
    }
    if (responseStreaming_ != false) {
      size += CodedOutputStream
  ...
  private static final Parser<Method>
